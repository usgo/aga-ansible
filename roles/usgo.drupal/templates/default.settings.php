 ...
 *
 */
$drupal_hash_salt = (file_exists("{{ usgo_drupal_salt_file }}") ? 
                        file_get_contents("{{ usgo_drupal_salt_file }}") : 
                        "{{ usgo_drupal_salt_file }}");
 ...
 * for you.
 */
$base_url = "{{ usgo_drupal_base_url }}";  // NO trailing slash!
